...
export default function ItemSkeleton() {
  ...
  return (
    <div className={`proyects__item !basis-[43%] shadow-xl card ${shimmer}`}>
      <div>
        <div className='proyects__item-title-container'>
          ...
          <h6
            className={`item__proyect-name !ml-2 h-5 !w-[30%] rounded bg-gray-200 dark:dark:bg-gray-500`}
          ></h6>
        </div>
        <div className='item__proyect-info !w-full flex flex-col gap-3'>
          <p
            className={`h-5 !w-[80%] rounded-md bg-gray-200 dark:dark:bg-gray-500`}
          ></p>
          <p
            className={`h-5 !w-[48%] rounded-md bg-gray-200 dark:dark:bg-gray-500`}
          ></p>
          <p
            className={`h-5 !w-[72%] rounded-md bg-gray-200 dark:dark:bg-gray-500`}
          ></p>
        </div>
      </div>
      <div className='item__proyect-branches '>
        ...
        <div className='flex items-center gap-2'>
          <span className='repo-language-color' style={{ background: '#333' }}>
            &nbsp;
          </span>
