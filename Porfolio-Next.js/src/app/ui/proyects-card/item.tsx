...
import { itemProyectEvent } from '@/app/lib/reactGA';
...
export default function Item(props: {
  ...
  return (
    <div className='proyects__item shadow-xl card dark:bg-violet min-h-[190.457px]'>
      ...
      <button
        className=' item__proyect-info text-start z-20'
        onClick={() => setToggleTruncateText(!toggleTruncateText)}
      >
        <p
          className={`text-base ${
            toggleTruncateText ? 'line-clamp-none' : 'line-clamp-3'
          } min-h-1:none pr-1`}
        >
          {props.description}
        </p>
